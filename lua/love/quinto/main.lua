function love.load()
    ...
    ball = {}
        ball.b = love.physics.newBody(world, 700,200, "dynamic")
        ball.b:setMass(100)
...
function love.draw()
    love.graphics.setColor(0, 255, 200, 50)
    love.graphics.circle("fill", ball.b:getX(),ball.b:getY(), ball.s:getRadius(), 500)
    love.graphics.setColor(255, 0, 255, 10)
